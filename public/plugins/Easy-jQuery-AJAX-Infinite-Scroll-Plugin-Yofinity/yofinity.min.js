...
//get ajax call
a.ajax({type:d.options.type.toUpperCase(),data:a.extend(d.options.params,{page: (d.options.iterator + 1) }),url:b,beforeSend:function(){d._loading()},error:function(){d._error(c)},success:function(a){d.options.iterator++,d._success(a,b,c)}}))},b.prototype._loading=function(){var a=this;
//change status
