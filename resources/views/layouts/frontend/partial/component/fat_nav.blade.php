<div class="fat-nav">
    <div class="top_nav_mb">
        <img src="{{ asset("img/common/satya_mb.png") }}" alt="Satya Logo" height="43">
    </div>
...
<div class="nav_header_mb">
    <div class="bound_img">
        <img src="{{ asset("img/home/mb_header.png") }}" alt="Logo Header Mobile">
    </div>
</div>
